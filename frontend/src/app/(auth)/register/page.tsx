        ...
        <div className="relative z-10 flex flex-col h-full max-w-xl mx-auto w-full">
          ...
          <div className="flex-1 flex flex-col justify-center mt-12">
            ...
            <p className="mt-6 text-slate-300 text-base leading-relaxed max-w-md font-medium">
              Join Digital Campus and unlock AI-powered tools designed to help you learn smarter and achieve more.
            </p>
      ...
      <div className="flex-1 flex flex-col justify-center px-8 sm:px-16 lg:px-24 bg-background relative">
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="mb-10 text-left">
            <h2 className="text-[32px] font-bold tracking-tight text-foreground">Create your account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              type="submit"
              disabled={isLoading}
              className="w-full flex items-center justify-center bg-[#1d3557] hover:bg-[#152744] text-white text-[15px] font-medium py-3 rounded-md transition-colors disabled:opacity-70 disabled:cursor-not-allowed mt-2"
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-background px-4 text-muted-foreground/70">or sign up with</span>
            </div>
          </div>
